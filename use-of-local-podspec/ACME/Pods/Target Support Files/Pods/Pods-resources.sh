...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "../../ACMECore/Resources/Hyphenate.bundle/hyph_en_US.dic"
  install_resource "../../ACMECore/Resources/Hyphenate.bundle/hyph_nb_NO.dic"
  install_resource "../../ACMECore/Resources/Hyphenate.bundle/hyph_nn_NO.dic"
  install_resource "../../ACMECore/Resources/Hyphenate.bundle"
  install_resource "../../ACMECore/Graphics/icon_arrow_right.png"
  install_resource "../../ACMECore/Graphics/icon_arrow_right@2x.png"
  ...
  install_resource "${BUILT_PRODUCTS_DIR}/ACMECore.bundle"
